    ...
    return (
        <div>
            <div className='flex flex-col md:flex-row bg-white'>
                ...
                <div className='md:w-1/2 flex flex-col items-center justify-center py-5'>
                    ...
                    <h4 className='text-[#444] text-xl font-bold pt-20 px-2'>OUR SIGNATURE HANDMADE BEEF PATTY</h4>
            ...
            {/* salad */}
            <div className='flex flex-col md:flex-row bg-[#28282B]'>
                <div className='md:w-1/2 flex flex-col items-center justify-center py-5'>
                    ...
                    <h4 className='text-white text-xl font-bold pt-20 px-2'>Life is like a burger the more you add to it, the
